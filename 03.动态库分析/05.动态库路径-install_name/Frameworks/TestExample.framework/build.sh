...
echo "----步骤2：TestExample.m -> TestExample动态库"
clang -dynamiclib  \
-target $TARGET \
-fobjc-arc \
-isysroot $SDK_PATH \
-install_name /Users/zhoushuai/Desktop/TestProjects/03.动态库分析/05.动态库路径-install_name/Frameworks/TestExample.framework/TestExample \
