...
[~/Desktop/VIP课程/第三节、动态库与静态库/静态库/上课代码/链接静态库AFNetworking]$ clang \
-x objective-c \
-target x86_64-apple-macos11.6 \
-fobjc-arc \
-isysroot /Applications/Xcode13.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk \
-I ./AFNetworking \
-c test.m -o test.o
